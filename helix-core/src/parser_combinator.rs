...
///
/// ```
/// use helix_core::parser_combinator::{or, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{token, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{pattern, Parser};
/// use regex::Regex;
...
///
/// ```
/// use helix_core::parser_combinator::{take_until, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{map, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{filter_map, take_until, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{filter, take_until, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{optional, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{left, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{right, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{zero_or_more, Parser};
...
///
/// ```
/// use helix_core::parser_combinator::{one_or_more, Parser};
...
///
/// ```rust
/// use helix_core::parser_combinator::{sep, Parser};
/// let parser = sep("a", ",");
...
mod test {
    ...
    #[test]
    fn seq_test() {
        let parser = seq!("123", "abc", "456");

        assert_eq!(Ok(("", ("123", "abc", "456"))), parser.parse("123abc456"));
        assert_eq!(Err("123def456"), parser.parse("123def456"));
    }

    #[test]
    fn choice_test() {
        let parser = choice!("123", "abc", "456");

        assert_eq!(Ok(("abc456", "123")), parser.parse("123abc456"));
        assert_eq!(Ok(("456", "abc")), parser.parse("abc456"));
        assert_eq!(Ok(("", "456")), parser.parse("456"));
        assert_eq!(Err("foo"), parser.parse("foo"));
    }
}
